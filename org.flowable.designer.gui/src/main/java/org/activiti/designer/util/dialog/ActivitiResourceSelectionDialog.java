 ...
 * @since 2.1
 */
public class ActivitiResourceSelectionDialog extends SelectionDialog {
  ...
  private static final String DIALOG_SETTINGS_SECTION = "ResourceListSelectionDialogSettings"; //$NON-NLS-1$
     ...
     */
    public ActivitiResourceSelectionDialog(Shell parentShell, IResource[] resources) {
        super(parentShell);
     ...
     */
    public ActivitiResourceSelectionDialog(Shell parentShell, IContainer container,
            int typeMask) {
        super(parentShell);
    ...
    public void setInitialPattern(final String pattern) {
